...
// tailscale_rebind reconnects DERP, rebinds the node's UDP sockets, and
// re-runs STUN — what a network change does. The OS can close a suspended process's sockets (observed on iOS), and
